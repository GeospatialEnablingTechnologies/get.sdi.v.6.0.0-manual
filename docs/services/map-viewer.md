...
| :---: | :--- | :--- |
| ![Zoom to extent icon](../assets/icons/locate-fixed.png) | **Zoom to extent** | Zooms and pans the map view to encompass the full geographic area of the selected layer. |
| ![Data table icon](../assets/icons/grid-3x3.png) | **Data table** | Opens an attribute table showing the underlying tabular data and attributes for all features in the layer. |
...
| ![Search features icon](../assets/icons/search.png) | **Search features** | Allows you to query and filter specific features or attributes within the selected layer. |
| ![Add to swipe icon](../assets/icons/square-split-horizontal.png) | **Add to swipe** | Adds the selected layer to the Swipe tool for interactive side-by-side comparison with other layers. |
...
| ![Rename layer icon](../assets/icons/pen-line.png) | **Rename layer** | Modifies the display name of the layer in your layer tree. |
| ![Remove layer icon](../assets/icons/trash.png) | **Remove layer** | Permanently deletes the layer from your current map session. |
